...
static int __init nxp_init(void)
{
	...
	printk("loading NXP PHY driver: [%s]\n",
...
/* error handling */
drv_registration_error:
	printk("NXP PHY: driver registration failed\n");
	return err;
}
...
{
	printk("unloading NXP PHY driver\n");
